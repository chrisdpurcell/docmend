...
| Plans | `docs/superpowers/plans/` | Safety-core Plans A-D are implemented. The active DMR-08 plan is `2026-07-11-million-file-scale-and-resource-contract.md`: Tasks 1-5 are complete; the revision 0.34/OQ-041 amendment splits Task 6 into 6A contract completion and 6B exact-HEAD installed-wheel orchestration without reordering Tasks 7-12. Task 6A is next. The safety-core plans stay until the v2.0.0 release PR lands. |
