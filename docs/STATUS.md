...
- The approved SPEC-VHHB revision 0.29 and ADRs 0001-0021 govern landed post-v1 changes (adr-0006 superseded by adr-0019); the decision backlog is empty. DMR-08 change control is designed but has not yet revised the binding SPEC or ADR set.
...
- DMR-08 now has an owner-approved [million-file scale design](superpowers/specs/2026-07-11-million-file-scale-and-resource-design.md) and an adversarially reviewed [12-task implementation plan](superpowers/plans/2026-07-11-million-file-scale-and-resource-contract.md). The design binds a one-million-file release qualification, sequential-only v2 configuration, plan schema 2.0, self-built exact-commit wheels, external uninstrumented RSS, pilot-derived executable thresholds, and public-safe evidence. Implementation is paused before Task 1 change control.
