...
| Plans | `docs/superpowers/plans/` | Safety-core Plans A-D are implemented. The active DMR-08 plan is `2026-07-11-million-file-scale-and-resource-contract.md`: Tasks 1-5 are complete; Task 6 (installed-wheel four-stage qualification orchestration and evidence acceptance) is next. The safety-core plans stay until the v2.0.0 release PR lands. |
