...
| Plans | `docs/superpowers/plans/` | Safety-core Plans A-D are implemented. The active DMR-08 plan is `2026-07-11-million-file-scale-and-resource-contract.md`: Tasks 1-8 are complete, including the revision 0.34/OQ-041 contract split, revision 0.36 runtime-boundary clarification, revision 0.37 Task 6B/7 evidence sync, and revision 0.38 Task 8 liveness/capacity evidence sync. Task 9's 10,000/100,000-file pilot and revision-two threshold freeze are next; Tasks 10-12 retain their approved order. The safety-core plans stay until the v2.0.0 release PR lands. |
