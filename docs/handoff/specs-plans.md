...
| Plans | `docs/superpowers/plans/` | Safety-core Plans A-D are implemented. The active DMR-08 plan is `2026-07-11-million-file-scale-and-resource-contract.md`: Tasks 1-10 are complete; Task 11's final independent approval and accepted file-size matrix are complete, while the accepted one-million-file evidence remains. Task 12 retains its approved closeout scope. The safety-core plans stay until the v2.0.0 release PR lands. |
