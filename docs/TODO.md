...
- [ ] Remediate the confirmed rollout blockers in the [2026-07-10 comprehensive review synthesis](codex-reviews/2026-07-10-2034-comprehensive-review-synthesis.md) per the approved [safety-core design](superpowers/specs/2026-07-10-safety-core-remediation-design.md) (spec rev 0.26/0.27, ADRs 0019-0021).
  ...
  - [ ] Sub-project 2 — scale/DMR-08: execute the owner-approved [million-file design](superpowers/specs/2026-07-11-million-file-scale-and-resource-design.md) through the reviewed [implementation plan](superpowers/plans/2026-07-11-million-file-scale-and-resource-contract.md). Next is Task 1: settle OQ-037, SPEC revision one, and ADR-0022/ADR-0007 change control. Then remove `parallel.*` with plan schema 2.0, build the evidence/resource harness, replace the stale scale test, add heartbeat/capacity controls, run the 10k/100k pilot and threshold revision, add the scheduled diagnostic, and qualify the file-size/1M release envelope before closing DMR-08.
