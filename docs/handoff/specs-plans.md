...
| Plans | `docs/superpowers/plans/` | Safety-core Plans A-D are implemented. The active DMR-08 plan is `2026-07-11-million-file-scale-and-resource-contract.md`: Tasks 1-9 are complete through the revision 0.40 pilot and threshold settlement. Task 10's scheduled/manual 100,000-file diagnostic is next; Tasks 11-12 retain their approved order. The safety-core plans stay until the v2.0.0 release PR lands. |
