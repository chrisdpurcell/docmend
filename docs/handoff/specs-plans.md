...
| Plans | `docs/superpowers/plans/` | Safety-core Plans A-D are implemented. The active DMR-08 plan is `2026-07-11-million-file-scale-and-resource-contract.md`: Tasks 1-6B are complete, including the revision 0.34/OQ-041 contract split and revision 0.36 runtime-boundary clarification. Task 7's 1,000-file source-tree PR guard is next; Tasks 8-12 retain their approved order. The safety-core plans stay until the v2.0.0 release PR lands. |
